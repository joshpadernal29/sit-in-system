        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm py-1 sticky-top">
            <div class="container-fluid px-lg-4">
                ...
                <a class="navbar-brand d-flex align-items-center" href="#" style="gap: 10px;">
                    ...
                    <div class="lh-1">
                        <span class="fw-bold d-block mb-0" style="font-size: 0.85rem; letter-spacing: 0.5px;">CCS ADMIN
                            PANEL</span>
                ...
                <div class="collapse navbar-collapse" id="adminNav">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 nav-underline">
                        ...
                        <li class="nav-item">
                            <a class="nav-link px-2 text-white d-flex align-items-center" href="sit_in_list.php"
                                style="font-size: 0.9rem;">
                                <i class="bi bi-person-video3 me-2"></i>Sit-in
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link px-2 text-white dropdown-toggle d-flex align-items-center" href="#"
